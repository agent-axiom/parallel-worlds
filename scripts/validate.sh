...
if grep -E '(src|href)="/(app\.js|chronology\.js|academic-data\.js|data-quality\.js|data\.js|i18n\.js|timeline\.js|atlas-data\.js|world-map-data\.js|insights\.js|atlas\.js|explorer-state\.js|atlas-view\.js|styles\.css)"' index.html; then
