(function (root, factory) {
  ...
  return {
    ...
    tracks: {
      ...
      xianrendong: [c('xianrendong-cave', 83, 48, -18050, -17050)],
      jomon: [c('japanese-archipelago-jomon', 89, 41, -10500, -300)],
      liangzhu: [c('lower-yangtze-liangzhu', 84, 45, -3300, -2300)],
      natufian: [c('southern-levant-natufian', 59, 42, -13050, -9550)],
      'gobekli-tepe': [c('gobekli-tepe-site', 58, 39, -9600, -8200)],
      catalhoyuk: [c('catalhoyuk-site', 58, 37, -7400, -6200)],
      'predynastic-nile': [c('upper-nile-predynastic', 58, 51, -5500, -3100)],
      mehrgarh: [c('kachi-plain-mehrgarh', 67, 46, -7000, -2600)],
      'european-palaeolithic-mesolithic': [c('european-sequences', 51, 34, -20000, -5000)],
      'late-pleistocene-americas': [c('north-american-evidence', 23, 38, -20000, -10900), c('south-american-evidence', 28, 66, -16000, -10900)],
      'sahul-continuity': [c('sahul', 90, 73, -20000, -3500)],
      lapita: [c('island-new-guinea-lapita', 91, 66, -1530, -1110)],
