(function (root, factory) {
  ...
  var copy = {
    ru: {
      ...
      editionCompanionLabel: 'Сопровождение подарочного издания',
      editionCompanionClose: 'Закрыть сопровождение',
      editionCompanionOpenAtlas: 'Исследовать этот момент в атласе',
      editionCompanionReconstruction: 'Реконструкция',
      editionCompanionSource: 'Источник изображения',
      editionCompanionImageUnavailable: 'Изображение появится после проверки прав и происхождения.',
      editionCompanionAnchor: 'Опорная дата: {year}',
    ...
    en: {
      ...
      editionCompanionLabel: 'Hardcover edition companion',
      editionCompanionClose: 'Close companion',
      editionCompanionOpenAtlas: 'Explore this moment in the atlas',
      editionCompanionReconstruction: 'Reconstruction',
      editionCompanionSource: 'Image source',
      editionCompanionImageUnavailable: 'An image will appear after rights and provenance review.',
      editionCompanionAnchor: 'Anchor date: {year}',
    ...
    zh: {
      ...
      editionCompanionLabel: '精装版数字伴读',
      editionCompanionClose: '关闭伴读',
      editionCompanionOpenAtlas: '在地图中探索这一时刻',
      editionCompanionReconstruction: '复原图',
      editionCompanionSource: '图像来源',
      editionCompanionImageUnavailable: '图像将在权利与来源审核完成后显示。',
      editionCompanionAnchor: '时间锚点：{year}',
