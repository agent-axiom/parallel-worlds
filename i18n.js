(function (root, factory) {
  ...
  var copy = {
    ru: {
      ...
      atlasAria: 'Карта активных исторических регионов', comparisonConnectorLabel: 'Сравнение: {title}', atlasYearLabel: 'Мир в выбранном году', atlasHint: 'Выберите светящуюся область, чтобы раскрыть её историю.',
    ...
    en: {
      ...
      atlasAria: 'Map of active historical regions', comparisonConnectorLabel: 'Comparison: {title}', atlasYearLabel: 'World in the selected year', atlasHint: 'Select a glowing region to reveal its history.',
    ...
    zh: {
      ...
      atlasAria: '活跃历史地区地图', comparisonConnectorLabel: '比较：{title}', atlasYearLabel: '所选年份的世界', atlasHint: '选择发光区域，探索其历史。',
